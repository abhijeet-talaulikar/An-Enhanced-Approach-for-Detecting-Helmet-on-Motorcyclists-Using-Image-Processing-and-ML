...
precision, recall, f1, support, accuracy, fn, roc_auc = 0, 0, 0, 0, 0, 0, 0
...
for train, test in kf.split(data):
	...
	clf = MLPClassifier(solver='lbfgs', activation ='logistic', learning_rate='adaptive', hidden_layer_sizes = (5,2), random_state=1)
...
#ROC curve
plt.title('Multi-Layer Perceptron (AUC = %s)' % round(roc_auc, 4))
